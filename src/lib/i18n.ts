...
export const DICT = {
  fr: {
    ...
    amu_sal:          "AMU Salarié (1 %)",
    cnss_pat:         "CNSS Patronal (15 %)",
    amu_pat:          "AMU Patronal (2.5 %)",
    total_retenues:   "Total retenues salariales (5 %)",
    total_charges:    "Total charges patronales (17.5 %)",
  ...
  en: {
    ...
    amu_sal:          "AMU Employee (1 %)",
    cnss_pat:         "CNSS Employer (15 %)",
    amu_pat:          "AMU Employer (2.5 %)",
    total_retenues:   "Total employee deductions (5 %)",
    total_charges:    "Total employer contributions (17.5 %)",
