...
export default function DeclarationsPage() {
  ...
  const declarations = data ? [
    ...
    {
      id: "is-annuel",
      nom: `Impôt sur les Sociétés (IS 27% / MFP 1%) — Liasse GUDEF`,
      periode: data.is.exercice,
      echeance: `${Number(data.is.exercice) + 1}-04-30`,
      type: "IS / Liasse",
      reference: "CGI art. 113, 120 & LPF art. 17, 49",
    ...
    {
      id: "is-acompte-2",
      nom: "2ème Acompte Provisionnel IS (25% de l'impôt N-1)",
      periode: String(currentYear),
    ...
    {
      id: "is-acompte-3",
      nom: "3ème Acompte Provisionnel IS (25% de l'impôt N-1)",
      periode: String(currentYear),
    ...
    {
      id: "is-acompte-4",
      nom: "4ème Acompte Provisionnel IS (25% de l'impôt N-1)",
      periode: String(currentYear),
