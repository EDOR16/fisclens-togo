...
export function exportPayrollExcel(
  ...
  const data = employees.map((e) => ({
    ...
    "AMU Salariale (5%)": e.payroll.amuSalariale,
    "Total Retenues Salariales (9%)": e.payroll.totalRetenueSalariale,
    "CNSS Patronale (15%)": e.payroll.cnssPatronale,
    "AMU Patronale (5%)": e.payroll.amuPatronale,
    "Total Charges Patronales (20%)": e.payroll.totalChargePatronale,
